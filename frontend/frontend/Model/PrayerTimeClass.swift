...
class PrayerTimesClass: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    func schedulePrayerTimeNotifications() {
        ...
        let prayerTimes = [
            ("Sabah", prayers.fajr),
            ("Podne", prayers.dhuhr),
            ("Ikindija", prayers.asr),
            ("Akšam", prayers.maghrib),
            ("Jacija", prayers.isha),
        ]
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        DispatchQueue.main.async {
            ...
            self.isLocationEnabled = true  // Postavite status lokacije na true kada su koordinate dostupne
    ...
    func startUpdatingLocation() {
        print("Start updating location. Current time: \(Date())")

        locationManager.delegate = self
        locationManager.startUpdatingLocation()
        locationManager.requestLocation()  // Dodajte zahtev za trenutno ažuriranje lokacije
        isLocationEnabled = CLLocationManager.locationServicesEnabled()  // Dodajte proveru statusa lokacije pri pokretanju praćenja
